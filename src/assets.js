module.exports = {
    ...
    signature: require("./assets/jasonpang.png"),
    signatureWhite: require("./assets/jasonpang-white.png"),
    bg1:'https://jasonpanggo-1256320333.cos.ap-shanghai.myqcloud.com/background1.jpg',
